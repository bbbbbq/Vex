...
use commands::{
    complete_configs_command, completions_command, exec_command, init_command, list_command,
    print_command, remove_command, rename_command, save_command,
};
...
pub fn run() -> Result<()> {
    ...
    match cli.command {
        ...
        Commands::Init(args) => init_command(args.shell, args.print),
